...
async function _renderSVG(users: { login: string; avatar: string }[]) {
  ...
  <text x="150" y="92" text-anchor="middle" class="heading" font-family="-apple-system, system-ui, sans-serif" font-size="13" font-weight="600" letter-spacing="0.05em">TOKEN DONORS</text>
  ...
  <text x="${width / 2}" y="92" text-anchor="middle" class="heading" font-family="-apple-system, system-ui, sans-serif" font-size="13" font-weight="600" letter-spacing="0.05em">TOKEN DONORS</text>
${items}
</svg>`;
}
