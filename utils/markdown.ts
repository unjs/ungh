 ...
 */
export function resolveMarkdownRelativeLinks(content: string, cdnBaseURL: string) {
  return content.replace(MARKDOWN_LINK_RE, (match, _, url: string | undefined, url2: string) => {
    const path = url || url2;
